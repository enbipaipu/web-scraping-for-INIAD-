...
exports.deploy_json = void 0;
var rest_1 = require("@octokit/rest");
var accessToken = "".concat(process.env.SLIDE_JSON_ACCESS_TOKEN);
var Owner = "enbipaipu";
var Repo = "test";
var github_filePath = "slid.json";
function deploy_json(json, is_finish) {
    return __awaiter(this, void 0, void 0, function () {
        var newDataToSendToGitHub, octokit, getSha, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    newDataToSendToGitHub = JSON.stringify(json, null, 2);
...
exports.deploy_json = deploy_json;
deploy_json('{"2024": {}}', true);
